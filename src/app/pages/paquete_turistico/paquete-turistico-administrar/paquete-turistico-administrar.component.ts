...
@Component({
  selector: 'app-paquete-turistico-administrar',
  templateUrl: './paquete-turistico-administrar.component.html',
  styleUrls: ['./paquete-turistico-administrar.component.css']
})
export class PaqueteTuristicoAdministrarComponent implements OnInit {
